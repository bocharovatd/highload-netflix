...
- User Service **Tarantool** 
    - 134 RPS
    - ROM ([размер хранения пользовательских данных](#размер-хранения)): 1_328 Tб
...
| Elasticsearch | Поиск и индексация в реальном времени | 1_000 | 128 ГБ |
| S3 | Объектное хранилище, высокая емкость | 500 | 32 ГБ |
| Cassandra | Распределенные записи, высокая доступность | 2_000 | 64 ГБ |
| PostgreSQL | Транзакционные CRUD-операции | 300 | 64 ГБ |

| Сервис | База данных | RPS | ROM | CPU (ядер) | RAM (на сервер) | ROM (на сервер) | Серверы (с резервированием) | Обоснование |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| User Service | Tarantool | 134 | 1_328 ТБ | 1 | 512 ГБ | 10 ТБ | 266 (133 × 2) | 1,328 ТБ / 10 ТБ = 133 сервера. Резервирование 2x. |
| Media Service | Elasticsearch | 241_579 | 408 ГБ | 242 | 128 ГБ | 2 ТБ | 8 (4 × 2) | 408 ГБ / 128 ГБ = 3.1 → 4 сервера. Резервирование 2x. |
| Streaming Service | S3 | 241_579 | 139 ПБ | 484 | 32 ГБ | 100 ТБ | 2_846 (1_423 × 2) | 139 ПБ / 100 ТБ = 1,423 сервера. Резервирование 2x. |
| Recommendation | Cassandra | 41_041 | 242 ТБ | 21 | 64 ГБ | 16 ТБ | 38 (19 × 2) | 242 ТБ / 16 ТБ = 15.1 → 16 серверов. Резервирование 2x. |
| Content Service | PostgreSQL | 940 | 6.3 ТБ | 4 | 64 ГБ | 2 ТБ | 8 (4 × 2) | 6.3 ТБ / 2 ТБ = 3.15 → 4 сервера. Резервирование 2x. |
...
| Название | Хостинг | Конфигурация | Cores | Cnt | Покупка | Аренда/мес |
| --- | --- | --- | --- | --- | --- | --- |
...
| cassandra-node | AWS | 2x6248/16x128GB/8xSSD4T/2x25Gb/s | 80 | 104 | - | $980 |
| postgres-node | AWS RDS | Managed (16 vCPU, 128 ГБ RAM) | 16 | 1 | - | $1,200 |
| search-node | AWS | 2x2680v4/8x32GB/2xSSD1T/2x10Gb/s | 28 | 1 | - | $0.25/hr |
| user-node | AWS | i5-13500/64GB/2xNVMe512Gb/2x10Gb/s | 14 | 1 | - | $60 |
