...
Тогда 0.1 * DAU * количество действий в день - количество действий в пиковый час.
| Наименование действия | Расчет | Пиковое потребление в течение суток |
| --- | --- | --- |
| регистрация на сайте | (0.1 * 48.8M * 0.02) * 1 Кб / 3600 * 8 | 0.0002 Гбит/сек |
| просмотр видео | (0.1 * 48.8M * 2.6) * (12 Гб / 5 * 0.75 * 1024 * 1024)Кб (размер 45 минут закодированного видео) / 3600 * 8 | 53_217.33 Гбит/сек |
| поиск | (0.1 * 48.8M * 1) * 1024 Кб / 3600 * 8 | 11.11 Гбит/сек |
| добавление в избранное | (0.1 * 48.8M * 0.5) * 0.2 Кб / 3600 * 8 | 0.0011 Гбит/сек |
| обращение к истории просмотров | (0.1 * 48.8M * 1) * 1024 Кб / 3600 * 8 | 11.11 Гбит/сек |
| просмотр уведомлений | (0.1 * 48.8M * 1.5) * 15 КБ / 3600 * 8 | 0.24 Гбит/сек |
...
| --- | --- | --- | --- | --- |
| регистрация на сайте | 48.8M * 0.02 / 86_400 | 11 | 0.1 * 48.8M * 0.02 / 3600 | 105 |
| просмотр видео | 48.8М * 2.6 / 86_400 | 1469 | 0.1 * 48.8М * 2.6 / 3600 | 13_594 |
| поиск | 48.8М * 1 / 86_400 | 565 | 0.1 * 48.8М * 1 / 3600 | 5229 |
| добавление в избранное | 48.8М * 0.5 / 86_400 | 282 | 0.1 * 48.8М * 0.5 / 3600 | 2614 |
| обращение к истории просмотров | 48.8М * 1 / 86_400 | 565 | 0.1 * 48.8М * 1 / 3600 | 5229 |
| просмотр уведомлений | 48.8М * 1.5 / 86_400 | 847 | 0.1 * 48.8М * 1.5 / 3600 | 7843 |
