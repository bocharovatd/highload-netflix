...
Netflix имеет 4 диапозона anycast [^21], которые предположительно связаны распределены по разным регионам (скорее всего, Северная Америка, Европа, Азия, Австралия).
